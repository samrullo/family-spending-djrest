...
ALLOWED_HOSTS = ["localhost","23.100.89.58","samrullobusiness.club","family-spending.local"]
...
INSTALLED_APPS = [
    ...
    # CORS headers to allow connections from whitelisted frontends
    'corsheaders'
]
...
HANDLER404 = 'family_spending.basic_views.custom_404'
